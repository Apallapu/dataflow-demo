...
public class CsvToBQPipeline {
    ...
    public static void main(String[] args) throws Throwable {
         ...
         String sourceFilePath = "gs://dataflowtestone/sample.csv";
         String tempLocationPath = "gs://poc-dataflow-tempone/bq";
         boolean isStreaming = false;
         TableReference tableRef = new TableReference();
         // Replace this with your own GCP project id
         tableRef.setProjectId("dataflow-demo-242812");
         tableRef.setDatasetId("dataflowdemo");
